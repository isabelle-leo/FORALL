...
#Supplemental plot: controls

#just mek/erk i, normalized to dmso
subset_raw_counts_plus_mekerk <- subset_raw_counts_plus[subset_raw_counts_plus$SubGroup != "25nM PMA",]
subset_raw_counts_plus_mekerk <- subset_raw_counts_plus_mekerk[subset_raw_counts_plus_mekerk$SubGroup != "25nM PMA, 1uM UO126",]
subset_raw_counts_plus_mekerk <- subset_raw_counts_plus_mekerk[subset_raw_counts_plus_mekerk$SubGroup != "25nM PMA, 1uM Tramatenib",]
subset_raw_counts_plus_mekerk <- subset_raw_counts_plus_mekerk[subset_raw_counts_plus_mekerk$SubGroup != "25nM PMA, 1uM Selumetinib",]
subset_raw_counts_plus_mekerk <- subset_raw_counts_plus_mekerk[subset_raw_counts_plus_mekerk$SubGroup != "25nM PMA, 1uM Erk11e",]
subset_raw_counts_plus_mekerk <- subset_raw_counts_plus_mekerk[subset_raw_counts_plus_mekerk$SubGroup != "100nM Bryostatin-1",]
subset_raw_counts_plus_mekerk <- subset_raw_counts_plus_mekerk[subset_raw_counts_plus_mekerk$SubGroup != "100nM Bryostatin-1, 1uM UO126",]
subset_raw_counts_plus_mekerk <- subset_raw_counts_plus_mekerk[subset_raw_counts_plus_mekerk$SubGroup != "100nM Bryostatin-1, 1uM Tramatenib",]
subset_raw_counts_plus_mekerk <- subset_raw_counts_plus_mekerk[subset_raw_counts_plus_mekerk$SubGroup != "100nM Bryostatin-1, 1uM Selumetinib",]
subset_raw_counts_plus_mekerk <- subset_raw_counts_plus_mekerk[subset_raw_counts_plus_mekerk$SubGroup != "100nM Bryostatin-1, 1uM Erk11e",]
subset_raw_counts_plus_mekerk <- subset_raw_counts_plus_mekerk[subset_raw_counts_plus_mekerk$CellType != "KASUMI 7",] #missing kasumi7

experiments <- unique(subset_raw_counts_plus_mekerk$ExperimentDate)
#make empty data frame for filling
normalized.to.dmso <- subset_raw_counts_plus_mekerk
...
for (i in 1:length(experiments)){
  ...
  one_experiment_subset <- subset_raw_counts_plus_mekerk[subset_raw_counts_plus_mekerk$ExperimentDate == experiments[i],]
...
p <- ggplot(data = normalized.to.dmso, aes(x = SubGroup, y = NormalizedDMSO), show.legend = F) +
  ...
  scale_color_manual(values = cell.line.palette) + 
...
library("ggpubr")
my_comparisons <- list(c("DMSO", "1uM Tramatenib"),
                       c("DMSO", "1uM UO126"),
                       c("DMSO", "1uM Selumetinib"),
                       c("DMSO", "1uM ERK11e"))
