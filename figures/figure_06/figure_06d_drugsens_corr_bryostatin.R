...
# labeling #FIMM003747...Bryostatin_1
genesToLabel <- c("HDAC9", "NFATC1", "RASGRP1", "PLCL2", "DNTT", "BCL11A", "NRAS", "RRAS", "VAV1", "MEF2C", "DGKH", "MAGI1")
...
# export to svg
ggsave(
  "protein_drugcorrelation_by_drug_bryostatin_1.svg",
  plot = p,
  device = NULL,
  path = outputFolder,
  scale = 1,
