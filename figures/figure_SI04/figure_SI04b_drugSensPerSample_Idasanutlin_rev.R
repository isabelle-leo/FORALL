...
# parameters
drugId <- c("FIMM136384") #Idasanutlin FIMM136384
                          
# highlight a cell line
#cellLineHighlight <- c("ALL.PO", "SEM")
...
library(svglite)
ggsave(
  "figure_SI04_drugSensPerSample_Idasanutlin_rev.svg",
  plot = p,
  device = NULL,
  path = outputFolder,
  scale = 1,
...
# export to png
ggsave(
  "figure_SI04_drugSensPerSample_Idasanutlin_rev.png",
  plot = p,
  device = NULL,
  path = outputFolder,
  scale = 1,
