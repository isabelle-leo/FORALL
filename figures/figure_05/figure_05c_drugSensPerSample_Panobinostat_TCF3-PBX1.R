...
# parameters
drugId <- c("FIMM003783") # FIMM003783	Panobinostat
...
library(svglite)
ggsave(
  "figure_05_drugSensPerSample_Panobinostat_TCF3-PBX1_rev.svg",
  plot = p,
  device = NULL,
  path = outputFolder,
  scale = 1,
...
# export to png
ggsave(
  "figure_05_drugSensPerSample_Panobinostat_TCF3-PBX1_rev.png",
  plot = p,
  device = NULL,
  path = outputFolder,
  scale = 1,
