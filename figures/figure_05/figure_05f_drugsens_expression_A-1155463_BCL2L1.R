...
# filter example to remove SEM.BR3
...
gois <- c("BCL2L1") 
drug <- c("FIMM136514") #FIMM115484 VEN, FIMM136514	A-1155463, FIMM136513	A-1331852
...
# export to svg
ggsave(
  "figure_04_drugsens_expression_A-1155463_BCL2L1_rev.svg",
  plot = p,
  device = NULL,
  path = outputFolder,
  scale = 1,
