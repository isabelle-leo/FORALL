...
# load proteins and drugs depending on desired comparison
...
gois <- c("TXNDC9")
drug <- c("FIMM003635") #FIMM133820 Triciribine #FIMM002374 SN_38 FIMM003635...Raltitrexed
...
outputFolder <- file.path("figures", "output") #temporary 
# export to svg
ggsave(
  "figure_SI05_drugsens_expression_Raltitrexed_TXNDC9_T_rev.svg",
  plot = p,
  device = NULL,
  path = outputFolder,
  scale = 1,
