...
gois <- c("FKBP10") #, "NRIP1"
drug <- c("FIMM001244") #FIMM000227 Dexamethasone, FIMM000484	Methylprednisolone, FIMM000519	Prednisolone #FIMM001244 Tacrolimus
...
# export to svg
ggsave(
  "figure_05_drugsens_expression_Tacrolimus_fkbp10_rev.svg",
  plot = p,
  device = NULL,
  path = outputFolder,
  scale = 1,
