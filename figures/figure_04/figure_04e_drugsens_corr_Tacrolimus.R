...
drug_protein_corr <- readRDS(file = file.path("data", "dsrt", "drugsens_protein_corr_ENS99_Filtered_2021-03-22.RDS")) #Correlations matrix

# parameters
drugId <- "FIMM001244" #FIMM001244 Tacrolimus 
labelColor <- "#555555"
segmentColor <- "#AAAAAA"
labelTop <- 10
labelBottom <- 10
...
# export to svg
ggsave(
  "figure_05_drugsens_corr_Tacrolimus_rev.svg",
  plot = p,
  device = NULL,
  path = outputFolder,
  scale = 1,
