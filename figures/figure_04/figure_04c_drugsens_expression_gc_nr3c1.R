...
gois <- c("NR3C1") #, "NRIP1"
drug <- c("FIMM000227", "FIMM000484", "FIMM000519") #FIMM000227 Dexamethasone, FIMM000484	Methylprednisolone, FIMM000519	Prednisolone 
...
# export to svg
ggsave(
  "figure_04_drugsens_expression_gc_nr3c1_rev.svg",
  plot = p,
  device = NULL,
  path = outputFolder,
  scale = 1,
